...
class Home extends Component {
    ...
    <section id="service" class="services-area">
                        ...
                        <div class="col-md-6">
                            <div class="services-content mt-40 d-sm-flex">
                                ...
                                <div class="services-content media-body">
                                    ...
                                    <p class="text">Short description for the ones<br> </br>who look for something new.</p>
                                </div>
                            </div> 
                        </div>
                        <div class="col-md-6">
        ...
        <div class="services-image d-lg-flex align-items-center">
            <div class="image">
                <img src="assets/images/services.png" alt="Services"></img>
            </div>
        </div> 
    </section>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing enterprise mt-40">
                        <div class="pricing-flower">
                            <img src="assets/images/flower.svg" alt="flower"></img>
                        </div>
    ...
    <section id="call-to-action" class="call-to-action">
        <div class="call-action-image">
            <img src="assets/images/call-to-action.png" alt="call-to-action"></img>
        </div>
